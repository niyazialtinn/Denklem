...
class MainActivity : android.app.Activity() {
    ...
    private fun buildUi() {
        ...
        root.addView(
            text(
                "Excel'deki eşit geri dönüş hesabı",
                14f
            )
        )
        ...
        // Oranlar ve sonuçlar için kaydırılabilir alan
    ...
    private fun buildOdds() {
        ...
        // Önceki sonuç referansını temizle
        resultView = null
    ...
    private fun calculate() {
        ...
        // Herhangi bir maç geldiğinde geri dönüş
        val payout =
            bankroll / reciprocal
